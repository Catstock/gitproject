...
class ASRTSpeechRecognition:
    def __init__(self):
        ...
        self.ms.load_model('save_models/' + self.sm251bn.get_model_name() + '.model.h5')
    ...
    def speech_recognition(self, wav_file):
        ...
        print('语音识别最终结果：\n', res)
        return res
ASRTsr=ASRTSpeechRecognition()
text=ASRTsr.speech_recognition('../PyQt-Sqlite-Project-CURD-master/user_audio.wav')